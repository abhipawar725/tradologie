            ...
            <div className="bg-white p-4 shadow-card rounded-lg">
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select name="type" id="type" className="w-full rounded-md border border-slate-200 text-sm px-3 py-2 outline-0">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select name="categoryId" id="category" className="w-full rounded-md border border-slate-200 text-sm px-3 py-2 outline-0">
                ...
                <div className="flex flex-col gap-1 col-span-2">
                  ...
                  {/* <div ref={editorRef} className="min-h-32"></div> */}
            ...
            <div className="bg-white p-4 shadow-card rounded-lg">
              <div className="flex flex-col gap-1">
                ...
                <div className="flex justify-center items-center relative w-full rounded-md cursor-pointer border-dashed border border-slate-200 text-sm px-3 py-2 outline-0 overflow-hidden h-20">
                  <input type="file" name="images" className="absolute top-0 left-0 w-full h-full opacity-0" />
                  <p>Upload Image</p>
                </div>
              </div>
            </div>
